まず、EC2、ターゲットグループ、ELB(ALB)を作成していきます。

<br>

<img src="https://github.com/user-attachments/assets/a0372007-8bbe-4867-9739-0bcec06d555b" width="70%" />
...
左メニューからロードバランサーのターゲットグループを選択し、③で作成したターゲットグループを選択します。

<br>

<img src="https://github.com/user-attachments/assets/e56fadf9-79b6-4043-ab1f-cc1a97f470ae" width="70%" />

<br><br>

「ターゲット」タブを開き、グループに登録したEC2のヘルスステータスが「Healthy」になっていることを確認します。

<br>

<img src="https://github.com/user-attachments/assets/056f7c5d-a792-44be-b32e-153c6e6542a0" width="70%" />

<br>

<img src="https://github.com/user-attachments/assets/859bcb9d-c38d-49cc-a4cb-e8ad03523134" width="70%" />

<br>

もし、「unhealthy」になっている場合は、下記の内容を確認してください。

<br>

+ EC2インスタンスが停止していないか
+ セキュリティグループの設定が適切か
+ EC2インスタンス構築時に記入した「ユーザーデータ」の内容に誤りがないか
　+　EC2インスタンスに対してSSH接続を行い、サーバ内部を確認する
...
<img src="https://github.com/user-attachments/assets/abc2dbc2-8ed7-4e04-8b7a-37e18a1be3e0" width="70%" />
...
<img src="https://github.com/user-attachments/assets/093430df-5508-4fa5-8c04-ead5dba3fd56" width="70%" />
...
<br><br>
<img src="https://github.com/user-attachments/assets/b9c981eb-2c69-4390-a36d-c4589cc9d746" width="70%" />
...
<img src="https://github.com/user-attachments/assets/dd596358-5968-435c-b5b5-dbbb6772c801" width="70%" />
...
<br>
<img width="70%" alt="image" src="https://github.com/user-attachments/assets/b9c19183-1e83-4ae8-a357-cb11fe549ef0">
...
Windowsの方はコマンドプロンプト、Macの空はターミナルを開き、curlコマンドでELBにアクセスすると、2台のEC2に振り分けられていることが確認できる。
...
<img width="70%" alt="image" src="https://github.com/user-attachments/assets/92bbda38-1487-4797-9676-6145b76b5bd0">
